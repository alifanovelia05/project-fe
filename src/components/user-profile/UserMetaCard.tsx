...
export default function UserMetaCard({ user }: UserMetaCardProps) {
  ...
  const getStatusBadge = (status: number) => {
    return status === 1 ? (
      <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-green-700 bg-green-50 rounded-full dark:bg-green-900/30 dark:text-green-300">
        <span className="w-1.5 h-1.5 bg-green-500 rounded-full"></span>
        Active
      </span>
    ) : (
      <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-gray-700 bg-gray-50 rounded-full dark:bg-gray-800 dark:text-gray-300">
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center">
            ...
            <div className="order-3 xl:order-2 flex-1">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {user ? getUserType(user.type) : "Loading..."}
                </p>
          ...
          {/* Button Edit disembunyikan sementara */}
          {/* <button
            onClick={openModal}
